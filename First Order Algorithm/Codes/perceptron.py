...
def PLA_problem_setup(A, b, x_init, max_iter, digit, fig_line, fig_title, A_test, b_test):
    ...
    for i in range(len(alphas)):
        pocket_algorithm(b, A, x_init, max_iter, alphas[i], fig_line, fig_objective, A_test, b_test)
    #pylab.legend()
...
def pocket_algorithm(b, A, x_init, max_iter, alpha, fig_line, fig_objective, A_test, b_test):
